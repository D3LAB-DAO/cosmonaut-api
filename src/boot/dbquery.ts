...
(async function(){
    ...
    try {
        ...
        // await client.query("INSERT INTO federated_credentials(provider, subject, name, create_at) VALUES($1, $2, $3, $4)", ['https://accounts.facebook.com', 'tkxkd0159', 'JAESEUNG LEE', new Date().toISOString()])
